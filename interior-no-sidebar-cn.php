<?php
/*
 Template Name: Interior No Sidebar Page - China
*/
?>
	...
	h1, h2 {
		color: <?php the_field('header_color'); ?>;
			...
			<div id="interior_tiles">
				<a href="<?php the_field('tile_1_link_china', 'option'); ?>" class="interior_tile">
					 <div class="tile_inner">
					 	<h3><?php the_field('tile_1_text_china', 'option'); ?></h3>
					 	<p><?php the_field('tile_1_description_china', 'option'); ?></p>
					 </div>
				...
				<?php $the_query = new WP_Query(array(
								...
								<?php endif; ?>
								<a href="<?php the_field('tile_3_link_china', 'option'); ?>" class="interior_tile">
									 <div class="tile_inner">
										<h3><?php the_field('tile_3_text_china', 'option'); ?></h3>
										<p><?php the_field('tile_3_description_china', 'option'); ?></p>
									 </div>
