			...
			<header class="header header-cn" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="upper_header" class="wrap cf">
					<div id="upper_header_phone">
						<div>
							<span class="upper_header_phone_title"><?php the_field('china_phone_1_name', 'option'); ?></span>
							<?php the_field('china_phone_1_number', 'option'); ?>
						</div>
						<div>
							<span class="upper_header_phone_title"><?php the_field('china_phone_2_name', 'option'); ?></span>
							<?php the_field('china_phone_2_number', 'option'); ?>
						</div>
					</div>
				...
				<div id="inner-header" class="wrap cf">
					...
					<p id="logo" class="h1" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php the_field('china_logo', 'option'); ?>" /></a></p>
