			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="upper_header" class="wrap cf">
					<div id="upper_header_phone">
						<div>
							<span class="upper_header_phone_title"><?php the_field('phone_1_name', 'option'); ?></span>
							<?php the_field('phone_1_number', 'option'); ?>
						</div>
						<div>
							<span class="upper_header_phone_title"><?php the_field('phone_2_name', 'option'); ?></span>
							<?php the_field('phone_2_number', 'option'); ?>
						</div>
						<div>
							<span class="upper_header_phone_title"><?php the_field('phone_3_name', 'option'); ?></span>
							<?php the_field('phone_3_number', 'option'); ?>
						</div>
					</div>
					...
					<?php
						if( have_rows('social_media_icons', 'option') ):
						    ...
						    endwhile;
						    echo '</div><div><a href="https://patientportal.viosnetwork.com " target="_blank" class="blue-btn">Patient Portal Login</a></div>';
						    echo '</div>';
						endif;
					?>
				</div>
